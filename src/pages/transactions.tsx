            ...
            <div className="transactions-wrapper">
                ...
                <div className="page-buttons">
                    ...
                    {numPages > 4 && separateButtons(numPages)[0].map(page =>
                        <button data-testid="page-btn" className="page-btn" key={page} onClick={() => setPageNumber(page)} disabled={pageNumber === page ? true : false}>{page}</button>
                    )}
                    {/* middle buttons with toggle */}
                    {numPages > 4 &&
                        <>
                            <button className={toggleActive ? 'toggle-btn cs-active' : 'toggle-btn'} onClick={() => changeToggle()}>
