...
export default function DeleteTransactionForm({ user, selected_transaction, hideDeleteForm }: deleteFormProps) {
    ...
    return (
        <form className="cs-form delete-form" action="" onSubmit={(e) => handleSubmit(e)}>
            ...
            <p>Are you sure you want to delete {selected_transaction.name}? This cannot be reversed!</p>
