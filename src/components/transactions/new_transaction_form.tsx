...
export default function NewTransactionForm({ user, recurringBills, updateRecurringBills, hideNewForm }: newFormProps) {
    ...
    return (
        <form data-testid="new-form" className="cs-form" action="" onSubmit={(e) => handleSubmit(e)}>
            <h2>New Transaction</h2>
            <button data-testid="close-btn" className="close-btn" type="button" onClick={hideNewForm}>
