...
export default function EditTransactionForm({ user, selected_transaction, recurringBills, updateRecurringBills, hideEditForm, toggleDelete }: editFormProps) {
    ...
    return (
        <form className="cs-form" action="" onSubmit={(e) => handleSubmit(e)}>
            ...
            <button className="close-btn" type="button" onClick={hideEditForm}>
            ...
            <p>Want to delete this transaction? <button className="delete-form-btn" type="button" onClick={() => toggleDelete(selected_transaction)}>Delete form</button></p>
